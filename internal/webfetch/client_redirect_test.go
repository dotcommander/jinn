...
//nolint:gocognit,revive // The table validates the complete multi-hop credential policy.
...
//nolint:revive // The table intentionally exercises all strict-origin dimensions together.
