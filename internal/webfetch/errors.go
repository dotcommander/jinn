...
//nolint:revive // Grouped exported constants are one stable machine-readable error-code contract.
const (
...
//
//nolint:revive // The exported constructor intentionally mirrors the private helper used inside this package.
func NewCodedError(err error, code, suggestion string) error {
